...
Route::post('estudiantes/getEstudiante', [EstudianteController::class, 'getStudentByNumeroControl']);

// Route::post('matriculas/filtrar', [MatriculaController::class, 'getMatriculasbyAula'])->name("filter");
Route::post('estudiantes/filtrar', [EstudianteController::class, 'getEstudianteByAula'])->name("filter");
Route::post('pagos/guardar', [PagoController::class, 'store']);

Route::resource('conceptos', ConceptoController::class)->names('conceptos')->middleware('auth');
...
Route::get('recibos/{recibo}/estudiante/invoice', [ReciboController::class, 'generateStudentInvoice'])->name('recibos.estudiante_invoice');
Route::get('recibos/{recibo}/coordinacion/invoice', [ReciboController::class, 'generateCoordinacionInvoice'])->name('recibos.coordinacion_invoice');
Route::get('reportes/{mes}', [ReporteController::class, 'generateReport'])->name('reportesMensuales');
