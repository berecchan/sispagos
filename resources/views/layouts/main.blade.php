          ...
          <div class="app-brand demo">
            <a href="#" class="app-brand-link">
              <span class="app-brand-logo demo">
                <img width="50" src="../assets/img/logo.jpeg" class="rounded" alt="">
              </span>
              <span class="app-brand-text demo menu-text fw-bolder ms-2 text-uppercase">CBTA 284</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="{{route('conceptos.index')}}" class="menu-link">
                ...
                <div data-i18n="Tables">Conceptos</div>
              </a>
            </li>
